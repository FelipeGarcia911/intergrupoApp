 ...
 * [ProspectLogFragment.OnListFragmentInteractionListener] interface.
 */
class ProspectLogFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_prospectlog_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyProspectLogRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
